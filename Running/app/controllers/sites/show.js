...
Sites.Show.View =
{
  ...
  initView: function()
  {
    ...
    self.View.messageView = $.messageView;
  },
...
Sites.Show.Controller =
{
  ...
  {
    self.View.runingLabel.color = "#007af";
    self.View.runningGroupLabel.color = "#ffff";
  ...
  onMessageViewClicked: function(event)
  {
    $.trigger("siteMessageView:click");
  },
  ...
  open: function()
  {
    ...
    self.View.messageView.addEventListener('click', self.Controller.onMessageViewClicked);
  },
