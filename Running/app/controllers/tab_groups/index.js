...
Tabgroup.Index.Controller =
{
  ...
  onSiteMessageViewClicked: function(event)
  {
    self.Controller.enabledTabName = 'messages/show';
    self.Controller.showActiveTabView();
  },
  ...
  showActiveTabView: function()
  {
    ...
    if (self.Controller.tabViews[self.Controller.enabledTabName])
    {
    ...
    else
    {
      ...
      {
        self.Controller.activeTab.on("siteMessageView:click", self.Controller.onSiteMessageViewClicked);
      }
